LinkLuaModifier('modifier_skill_hero_shenfen', 'skill/hero_shenfen2.lua', 0)


skill_hero_shenfen2=class({})

function skill_hero_shenfen2:GetIntrinsicModifierName()
	return "modifier_skill_hero_shenfen"
end

modifier_skill_hero_shenfen=class({})

function modifier_skill_hero_shenfen:OnCreated()
