...
modifier_item_weapon_008_unit = class({modifier_item_weapon_008_hero})--给民兵的效果

function item_weapon_008:GetIntrinsicModifierName()
    return "modifier_item_weapon_008_hero"
end
