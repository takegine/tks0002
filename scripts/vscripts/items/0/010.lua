...
modifier_item_weapon_010_unit = class({modifier_item_weapon_010_hero})--给民兵的效果

function item_weapon_010:GetIntrinsicModifierName()
    return "modifier_item_weapon_010_hero"
end
